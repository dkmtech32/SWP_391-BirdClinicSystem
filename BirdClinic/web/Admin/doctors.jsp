				...
				<div class="sidebar-content" data-simplebar style="height: calc(100% - 60px)">
					...
					<ul class="sidebar-menu pt-3">
						...
						<li class="sidebar-dropdown">
							...
							<div class="sidebar-submenu">
								<ul>
									...
									<li><a href="dr-profile.html">Doctor Profile</a></li>
								</ul>
							</div>
						</li>
						...
						<li class="sidebar-dropdown">
							...
							<div class="sidebar-submenu">
								<ul>
									<li><a href="staff.html">Staffs List</a></li>
									<li><a href="add-staff.html">Add Staff</a></li>
									<li><a href="staff-profile.html">Staffs Profile</a></li>
								</ul>
							</div>
						</li>

						<li>
							<a href="customer.html"><i class="uil fa-solid fa-person me-2 d-inline-block"></i>Customers List</a>
						</li>
									...
									<table class="table mb-0 table-center">
										...
										<tbody>
											<tr>
												...
												<td class="p-3">CalvinKool58</td>
												<td class="p-3">doctor@birdlover.com</td>
												<td class="p-3">(+84) 123 456 78</td>
												<td class="p-3">Male</td>
												<td class="p-3">12/03/1992</td>
												<td class="p-3">
													<span class="badge bg-soft-success">Doctor of Veterinary Medicine (DVM)</span>
												</td>
												<td class="p-3"><span class="badge bg-soft-success">Veterinary Surgeon</span></td>
