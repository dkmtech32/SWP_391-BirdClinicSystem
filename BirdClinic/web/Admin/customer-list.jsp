                                    ...
                                    <table class="table table-center bg-white mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom p-3" style="min-width: 50px">User Name</th>
                                                ...
                                                <th class="border-bottom p-3">Number of birds</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-3">
                                                    <a href="#" class="text-dark">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../assets/images/client/${list.img}" class="avatar avatar-md-sm rounded-circle shadow" alt />
                                                            <span class="ms-2"${list.name}</span>
                                                        </div>
                                                    </a>
                                                </td>
                                                <td class="p-3">${list.username}</td>
                                                <td class="p-3">${list.age}</td>
                                                <td class="p-3">${list.sex}</td>
                                                <td class="p-3">${list.address}</td>
                                                <td class="p-3">${list.phone}</td>
                                                <td class="p-3">${list.numberOfBird}</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input name="degree" id="text" type="text" class="form-control" value="85/5 Pham Van Hai" />
                                    </div>
                                </div>
                            </div>
                            <!--end row-->
