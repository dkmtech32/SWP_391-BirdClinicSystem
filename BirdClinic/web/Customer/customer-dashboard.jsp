                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-center mb-0">
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="list" items="${requestScope.cusApp}">
                                                                    <tr>
                                                                        <td>
                                                                            <h2 class="table-avatar">
                                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                                    <img class="avatar-img rounded-circle" src="../assets/img/doctors/${list.docimg}" alt="User Image" />
                                                                                </a>
                                                                                <a href="doctor-profile.html">${list.docname}<span>${list.docDegree}</span></a>
                                                                            </h2>
                                                                        </td>
                                                                        <td>${list.appdate}<span class="d-block text-info">${list.apptime}</span></td>
                                                                        <td>${list.bookdate}</td>
                                                                        <td>
                                                                            <c:choose>
                                                                                <c:when test="${list.appStatus}=='processing'">                                                                            
                                                                                    <span class="badge badge-pill bg-warning-light">Processing</span>
                                                                                </c:when>
                                                                                <c:when test="${list.appStatus}=='confirm'">                                                                            
                                                                                    <span class="badge badge-pill bg-success-light">Confirmed</span>
                                                                                </c:when>
                                                                                <c:when test="${list.appStatus}=='check-in'">                                                                            
                                                                                    <span class="badge badge-pill bg-success-light">Checked-in</span>
                                                                                </c:when>
                                                                                <c:when test="${list.appStatus}=='complete'">   
                                                                        ...
                                                                        <td class="text-right">
                                                                            <div class="table-action">
                                                                                <a href="javascript:void(0);" class="btn btn-sm bg-danger-light"> <i class="fa fa-times"></i> Cancel </a>
